...
public final class Codecs {
  ...
  public static final ImmutableList<Codec> CODECS_NEW =
      new ImmutableList.Builder<Codec>()
          .add(
              new Codec("012v", "Uncompressed 4:2:2 10-bit", "D.VI.."),
              ...
              new Codec("avrp", "Avid 1:1 10-bit RGB Packer", "DEVI.."),
              new Codec("avs", "AVS (Audio Video Standard) video", "D.V.L."),
              new Codec("avui", "Avid Meridien Uncompressed", "DEVI.."),
              new Codec("ayuv", "Uncompressed packed MS 4:4:4:4", "DEVI.."),              
              ...
              new Codec("h264", "H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10 (decoders: h264 h264_vda ) (encoders: libx264 libx264rgb h264_videotoolbox )", "DEV.LS"),
              new Codec("hap", "Vidvox Hap decoder", "D.VIL."),
              new Codec("hevc", "H.265 / HEVC (High Efficiency Video Coding)", "D.V.L."),
              ...
              new Codec("jpeg2000", "JPEG 2000", "DEVILS"),
              ...
              new Codec("mpeg1video", "MPEG-1 video", "DEV.L."),
              new Codec("mpeg2video", "MPEG-2 video (decoders: mpeg2video mpegvideo )", "DEV.L."),
              new Codec("mpeg4", "MPEG-4 part 2 (encoders: mpeg4 libxvid )", "DEV.L."),
              new Codec("mpegvideo_xvmc", "MPEG-1/2 video XvMC (X-Video Motion Compensation)", "..V.L."),              
              ...
              new Codec("prores", "Apple ProRes (iCodec Pro) (decoders: prores prores_lgpl ) (encoders: prores prores_aw prores_ks )", "DEVIL."),
              ...
              new Codec("targa_y216", "Pinnacle TARGA CineWave YUV16", "D.VI.."),
              ...
              new Codec("truemotion2rt", "Duck TrueMotion 2.0 Real Time", "D.V.L."),
              ...
              new Codec("v308", "Uncompressed packed 4:4:4", "DEVI.."),
              new Codec("v408", "Uncompressed packed QT 4:4:4:4", "DEVI.."),
              ...
              new Codec("vc1", "SMPTE VC-1", "D.V.L."),
              ...
              new Codec("vp8", "On2 VP8", "D.V.L."),
              new Codec("vp9", "Google VP9", "D.V.L."),
              new Codec("webp", "WebP", "D.VILS"),
              ...
              new Codec("wrapped_avframe", "AVFrame to AVPacket passthrough", ".EV..S"),
              ...
              new Codec("y41p", "Uncompressed YUV 4:1:1 12-bit", "DEVI.."),
              new Codec("ylc", "YUY2 Lossless Codec", "D.VI.S"),
              new Codec("yop", "Psygnosis YOP Video", "D.V.L."),
              new Codec("yuv4", "Uncompressed packed 4:2:0", "DEVI.."),
              ...
              new Codec("aac", "AAC (Advanced Audio Coding) (decoders: aac aac_fixed aac_at ) (encoders: aac aac_at )", "DEA.L."),
              new Codec("aac_latm", "AAC LATM (Advanced Audio Coding LATM syntax)", "D.A.L."),
              new Codec("ac3", "ATSC A/52A (AC-3) (decoders: ac3 ac3_fixed ac3_at ) (encoders: ac3 ac3_fixed )", "DEA.L."),
              ...
              new Codec("adpcm_g726le", "G.726 ADPCM little-endian (decoders: g726le )", "D.A.L."),
              ...
              new Codec("adpcm_ima_qt", "ADPCM IMA QuickTime (decoders: adpcm_ima_qt adpcm_ima_qt_at )", "DEA.L."),
              ...
              new Codec("alac", "ALAC (Apple Lossless Audio Codec) (decoders: alac alac_at ) (encoders: alac alac_at )", "DEA..S"),
              new Codec("amr_nb", "AMR-NB (Adaptive Multi-Rate NarrowBand) (decoders: amrnb amr_nb_at )", "D.A.L."),
              new Codec("amr_wb", "AMR-WB (Adaptive Multi-Rate WideBand) (decoders: amrwb )", "D.A.L."),
              ...
              new Codec("atrac3p", "ATRAC3+ (Adaptive TRansform Acoustic Coding 3+) (decoders: atrac3plus )", "D.A.L."),
              ...
              new Codec("dsd_lsbf", "DSD (Direct Stream Digital), least significant bit first", "D.A.L."),
              new Codec("dsd_lsbf_planar", "DSD (Direct Stream Digital), least significant bit first, planar", "D.A.L."),
              new Codec("dsd_msbf", "DSD (Direct Stream Digital), most significant bit first", "D.A.L."),
              new Codec("dsd_msbf_planar", "DSD (Direct Stream Digital), most significant bit first, planar", "D.A.L."),
              new Codec("dsicinaudio", "Delphine Software International CIN audio", "D.A.L."),
              new Codec("dss_sp", "Digital Speech Standard - Standard Play mode (DSS SP)", "D.A.L."),
              new Codec("dst", "DST (Direct Stream Transfer)", "D.A..S"),
              new Codec("dts", "DCA (DTS Coherent Acoustics) (decoders: dca ) (encoders: dca )", "DEA.LS"),
              new Codec("dvaudio", "DV audio", "D.A.L."),
              new Codec("eac3", "ATSC A/52B (AC-3, E-AC-3) (decoders: eac3 eac3_at )", "DEA.L."),
              new Codec("evrc", "EVRC (Enhanced Variable Rate Codec)", "D.A.L."),
              new Codec("flac", "FLAC (Free Lossless Audio Codec)", "DEA..S"),
              new Codec("g723_1", "G.723.1", "DEA.L."),
              new Codec("g729", "G.729", "D.A.L."),
              new Codec("gsm", "GSM", "D.A.L."),
              new Codec("gsm_ms", "GSM Microsoft variant (decoders: gsm_ms gsm_ms_at )", "D.A.L."),
              new Codec("iac", "IAC (Indeo Audio Coder)", "D.A.L."),
              new Codec("ilbc", "iLBC (Internet Low Bitrate Codec) (decoders: ilbc_at ) (encoders: ilbc_at )", "DEA.L."),
              ...
              new Codec("mp1", "MP1 (MPEG audio layer 1) (decoders: mp1 mp1float mp1_at )", "D.A.L."),
              new Codec("mp2", "MP2 (MPEG audio layer 2) (decoders: mp2 mp2float mp2_at ) (encoders: mp2 mp2fixed )", "DEA.L."),
              new Codec("mp3", "MP3 (MPEG audio layer 3) (decoders: mp3 mp3float mp3_at ) (encoders: libmp3lame )", "DEA.L."),
              new Codec("mp3adu", "ADU (Application Data Unit) MP3 (MPEG audio layer 3) (decoders: mp3adu mp3adufloat )", "D.A.L."),
              new Codec("mp3on4", "MP3onMP4 (decoders: mp3on4 mp3on4float )", "D.A.L."),
              ...
              new Codec("opus", "Opus (Opus Interactive Audio Codec)", "D.A.L."),
              new Codec("paf_audio", "Amazing Studio Packed Animation File Audio", "D.A.L."),
              new Codec("pcm_alaw", "PCM A-law / G.711 A-law (decoders: pcm_alaw pcm_alaw_at ) (encoders: pcm_alaw pcm_alaw_at )", "DEA.L."),
              new Codec("pcm_bluray", "PCM signed 16|20|24-bit big-endian for Blu-ray media", "D.A..S"),
              ...
              new Codec("pcm_mulaw", "PCM mu-law / G.711 mu-law (decoders: pcm_mulaw pcm_mulaw_at ) (encoders: pcm_mulaw pcm_mulaw_at )", "DEA.L."),
              ...
              new Codec("qdm2", "QDesign Music Codec 2 (decoders: qdm2 qdm2_at )", "D.A.L."),
              new Codec("qdmc", "QDesign Music (decoders: qdmc_at )", "D.A.L."),
              new Codec("ra_144", "RealAudio 1.0 (14.4K) (decoders: real_144 ) (encoders: real_144 )", "DEA.L."),
              ...
              new Codec("sonicls", "Sonic lossless", ".EA..."),
              new Codec("speex", "Speex", "..A.L."),
              new Codec("tak", "TAK (Tom's lossless Audio Kompressor)", "D.A..S"),
              new Codec("truehd", "TrueHD", "DEA..S"),
              new Codec("truespeech", "DSP Group TrueSpeech", "D.A.L."),
              new Codec("tta", "TTA (True Audio)", "DEA..S"),
              new Codec("twinvq", "VQF TwinVQ", "D.A.L."),
              new Codec("vmdaudio", "Sierra VMD audio", "D.A.L."),
              new Codec("vorbis", "Vorbis", "DEA.L."),
              new Codec("voxware", "Voxware RT29 Metasound", "..A.L."),
              new Codec("wavesynth", "Wave synthesis pseudo-codec", "D.A..."),
              new Codec("wavpack", "WavPack", "DEA.LS"),
